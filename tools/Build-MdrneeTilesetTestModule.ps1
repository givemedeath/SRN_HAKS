...
if ([string]$fixture.customTlk -cnotmatch '^[a-z0-9_]{1,16}$') {
    throw "Fixture customTlk '$($fixture.customTlk)' is not a valid TLK resref."
}
...
$nwnGff = Get-SrnTool -Name gff
$nwnErf = Get-SrnTool -Name erf
...
$ifo = [ordered]@{
    ...
    Mod_CustomTlk = New-GffField 'cexostring' ([string]$fixture.customTlk)
...
if ([string]$decodedIfo.Mod_CustomTlk.value -cne [string]$fixture.customTlk) {
    throw "Round-trip module.ifo does not declare custom TLK '$($fixture.customTlk)'."
}
...
$receipt = [ordered]@{
    ...
    module = [ordered]@{
        ...
        customTlk = [string]$fixture.customTlk
        entryArea = $entryArea
